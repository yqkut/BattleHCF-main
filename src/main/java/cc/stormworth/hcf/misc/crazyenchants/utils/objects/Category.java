...
public class Category {
    ...
    public Category(String name, int slot, boolean inGUI, ItemBuilder displayItem, int cost, int rarity, LostBook lostBook, int maxSuccessRate, int minSuccessRate, int maxDestroyRate, int minDestroyRate, boolean useMaxLevel, int maxLevel, int minLevel) {
        this.name = name;
        this.slot = slot - 1;
        this.inGUI = inGUI;
