...
public class StoneBlocksMenu extends Menu {

  int[] glassslots = new int[]{0, 1, 7, 8, 9, 17, 27, 36, 37, 35, 43, 44};

  public StoneBlocksMenu() {
  ...
  public Map<Integer, Button> getButtons(Player player) {
    ...
    buttons.put(13, new PurchaseBalButton(ItemBuilder.of(Material.BRICK).amount(64).build(), 64));

    buttons.put(20,
        new PurchaseBalButton(ItemBuilder.of(Material.COBBLE_WALL).amount(64).build(), 64));
    buttons.put(21,
        new PurchaseBalButton(ItemBuilder.of(Material.BRICK_STAIRS).amount(64).build(), 64));
    buttons.put(23, new PurchaseBalButton(ItemBuilder.of(Material.STEP).amount(64).build(), 64));
    buttons.put(24, new PurchaseBalButton(
        ItemBuilder.of(Material.COBBLE_WALL).amount(64).data((short) 1).build(), 64));
    buttons.put(31,
        new PurchaseBalButton(ItemBuilder.of(Material.STONE).amount(64).data((short) 1).build(),
            64));
    ...
    buttons.put(getSlot(5, 5), Button.fromItem(new ItemBuilder(Material.EMERALD)
        ...
        (other) -> new BuyConfirmation((player1) -> {
          ...
          player1.getInventory().addItem(ItemBuilder.of(Material.BRICK).amount(64).build());
          player1.getInventory().addItem(ItemBuilder.of(Material.COBBLE_WALL).amount(64).build());
          player1.getInventory().addItem(ItemBuilder.of(Material.BRICK_STAIRS).amount(64).build());
          player1.getInventory().addItem(ItemBuilder.of(Material.STEP).amount(64).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.COBBLE_WALL).amount(64).data((short) 1).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STONE).amount(64).data((short) 1).build());
