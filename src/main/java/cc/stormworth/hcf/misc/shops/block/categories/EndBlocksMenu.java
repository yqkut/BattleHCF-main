...
public class EndBlocksMenu extends Menu {

  int[] glassslots = new int[]{0, 1, 7, 8, 9, 17, 18, 19, 25, 26};

  public EndBlocksMenu() {
  ...
  public Map<Integer, Button> getButtons(Player player) {
    ...
    buttons.put(13, new PurchaseBalButton(ItemBuilder.of(Material.ENDER_STONE, 64).build(), 64));
    ...
    buttons.put(getSlot(5, 5), Button.fromItem(new ItemBuilder(Material.EMERALD)
        ...
        (other) -> new BuyConfirmation((player1) -> {
          ...
          player1.getInventory().addItem(ItemBuilder.of(Material.ENDER_STONE, 64).build());
