...
public class GlassBlocskMenu extends Menu {

  int[] glassslots = new int[]{0, 1, 7, 8, 9, 17, 27, 36, 37, 35, 43, 44};

  public GlassBlocskMenu() {
  ...
  public Map<Integer, Button> getButtons(Player player) {
    ...
    buttons.put(11, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 0).build(), 64));
    buttons.put(12, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 1).build(), 64));
    buttons.put(13, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 2).build(), 64));
    buttons.put(14, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 3).build(), 64));
    buttons.put(15, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 4).build(), 64));

    buttons.put(19, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 5).build(), 64));
    buttons.put(20, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 6).build(), 64));
    buttons.put(21, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 7).build(), 64));

    buttons.put(22, new PurchaseBalButton(ItemBuilder.of(Material.GLASS).amount(64).build(), 250));

    buttons.put(23, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 8).build(), 64));
    buttons.put(24, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 9).build(), 64));
    buttons.put(25, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 10).build(), 64));

    buttons.put(29, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 11).build(), 64));
    buttons.put(30, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 12).build(), 64));
    buttons.put(31, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 13).build(), 64));
    buttons.put(32, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 14).build(), 64));
    buttons.put(33, new PurchaseBalButton(
        ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 15).build(), 64));
    ...
    buttons.put(getSlot(5, 5), Button.fromItem(new ItemBuilder(Material.EMERALD)
        ...
        (other) -> new BuyConfirmation((player1) -> {
          ...
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 0).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 1).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 2).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 3).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 4).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 5).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 6).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 7).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 8).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 9).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 10).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 11).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 12).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 13).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 14).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.STAINED_GLASS).amount(64).data((short) 15).build());
          player1.getInventory().addItem(ItemBuilder.of(Material.GLASS).amount(64).build());
