...
public class WoodBlocksMenu extends Menu {

  int[] glassslots = new int[]{0, 1, 7, 8, 9, 17, 27, 36, 37, 35, 43, 44};

  public WoodBlocksMenu() {
  ...
  public Map<Integer, Button> getButtons(Player player) {
    ...
    buttons.put(20,
        new PurchaseBalButton(ItemBuilder.of(Material.LOG).amount(64).data((short) 0).build(),
            800));
    buttons.put(21,
        new PurchaseBalButton(ItemBuilder.of(Material.LOG).amount(64).data((short) 1).build(),
            800));
    buttons.put(22,
        new PurchaseBalButton(ItemBuilder.of(Material.LOG).amount(64).data((short) 2).build(),
            800));
    buttons.put(23,
        new PurchaseBalButton(ItemBuilder.of(Material.LOG).amount(64).data((short) 3).build(),
            800));
    buttons.put(24,
        new PurchaseBalButton(ItemBuilder.of(Material.LOG_2).amount(64).data((short) 1).build(),
            800));
    ...
    buttons.put(getSlot(5, 5), Button.fromItem(new ItemBuilder(Material.EMERALD)
        ...
        (other) -> new BuyConfirmation((player1) -> {
          ...
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.LOG).amount(64).data((short) 0).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.LOG).amount(64).data((short) 1).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.LOG).amount(64).data((short) 2).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.LOG).amount(64).data((short) 3).build());
          player1.getInventory()
              .addItem(ItemBuilder.of(Material.LOG_2).amount(64).data((short) 1).build());
