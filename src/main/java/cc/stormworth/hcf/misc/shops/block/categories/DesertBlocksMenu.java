...
public class DesertBlocksMenu extends Menu {

  int[] glassslots = new int[]{0, 1, 7, 8, 9, 17, 18, 19, 25, 26};

  public DesertBlocksMenu() {
  ...
  public Map<Integer, Button> getButtons(Player player) {
    ...
    buttons.put(11,
        new PurchaseBalButton(ItemBuilder.of(Material.SANDSTONE).amount(64).build(), 64));
    buttons.put(12,
        new PurchaseBalButton(ItemBuilder.of(Material.SANDSTONE).amount(64).data((short) 1).build(),
            64));
    buttons.put(13,
        new PurchaseBalButton(ItemBuilder.of(Material.STEP).amount(64).data((short) 1).build(),
            64));
    buttons.put(14,
        new PurchaseBalButton(ItemBuilder.of(Material.SANDSTONE_STAIRS).amount(64).build(), 64));
    buttons.put(15,
        new PurchaseBalButton(ItemBuilder.of(Material.SANDSTONE).amount(64).data((short) 2).build(),
            64));
    ...
    buttons.put(getSlot(5, 5), Button.fromItem(new ItemBuilder(Material.EMERALD)
        ...
        (other) -> new BuyConfirmation((player1) -> {
          ...
          player1.getInventory().addItem(new ItemBuilder(Material.SANDSTONE).amount(64).build());
          player1.getInventory()
              .addItem(new ItemBuilder(Material.SANDSTONE).amount(64).data((short) 1).build());
          player1.getInventory()
              .addItem(new ItemBuilder(Material.STEP).amount(64).data((short) 1).build());
          player1.getInventory()
              .addItem(new ItemBuilder(Material.SANDSTONE_STAIRS).amount(64).build());
          player1.getInventory()
              .addItem(new ItemBuilder(Material.SANDSTONE).amount(64).data((short) 2).build());
