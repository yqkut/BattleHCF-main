package cc.stormworth.hcf.util.countdown;
...
public class CountdownBuilder {
  ...
  private List<Integer> broadcastAt;
  ...
  public CountdownBuilder(final int seconds) {
  ...
  public Countdown start() {
    ...
    return new Countdown(this.seconds, this.message,
        this.tickHandler, this.broadcastHandler,
        this.finishHandler, this.messageFilter, playerList, this.convertIntegers(this.broadcastAt));
  }
