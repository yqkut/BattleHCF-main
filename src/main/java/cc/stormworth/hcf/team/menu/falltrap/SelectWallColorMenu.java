...
public class SelectWallColorMenu extends Menu {
    private final FalltrapMenu parent;

    @Override
    public String getTitle(Player player) {
        return "&eSelect walls Color";
    }
            ...
            if (!isBorder(startSlot.get())){
                buttons.put(startSlot.get(), new Button() {
                    ...
                    public void clicked(Player player, int slot, ClickType clickType) {
                        parent.setSelectedMaterial(Material.WOOL);
                        parent.setSelectedData(i);
