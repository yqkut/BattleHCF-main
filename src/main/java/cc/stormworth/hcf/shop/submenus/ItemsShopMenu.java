...
public class ItemsShopMenu extends Menu {
  ...
  public Map<Integer, Button> getButtons(Player player) {
    ...
    buttons.put(getSlot(3, 1),
        new BuyItemButton("End Frame", 1000, 1, new ItemStack(Material.ENDER_PORTAL_FRAME)));

    buttons.put(getSlot(3, 2),
        new BuyItemButton("Beacon", 20000, 1, new ItemStack(Material.BEACON)));

    buttons.put(getSlot(5, 2),
        new BuyItemButton("Golden Apple", 2000, 8, new ItemStack(Material.GOLDEN_APPLE)));

    buttons.put(getSlot(3, 3),
        new BuyItemButton("Gapple", 80000, 1,
            new ItemBuilder(Material.GOLDEN_APPLE).data((short) 1).build()));
    buttons.put(getSlot(4, 3),
        new BuyItemButton("Sheers", 500, 1, new ItemStack(Material.SHEARS)));

    buttons.put(getSlot(5, 3),
        new BuyItemButton("Fishing Rod", 1000, 1, new ItemStack(Material.FISHING_ROD)));
    ...
    buttons.put(getSlot(5, 5), Button.fromItem(new ItemBuilder(Material.EMERALD)
        ...
        (other) -> new BuyConfirmation((player1) -> {
          ...
          player1.getInventory().addItem(new ItemStack(Material.GOLDEN_APPLE, 32));

          player1.getInventory()
              .addItem(new ItemBuilder(Material.GOLDEN_APPLE).data((short) 1).build());
          player1.getInventory().addItem(new ItemStack(Material.SHEARS));
          player1.getInventory().addItem(new ItemStack(Material.WEB));
